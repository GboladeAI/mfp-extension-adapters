...
import com.ibm.mfp.adapters.sample.model.Log;
...
public class LogExport   {
  ...
  public LogExport request(MessageRequest request) {
  ...
  **/
  @JsonProperty("request")
  @ApiModelProperty(required = true, value = "A request formatted for the Conversation service.")
  @NotNull
  ...
  public LogExport response(MessageResponse response) {
  ...
  **/
  @JsonProperty("response")
  @ApiModelProperty(required = true, value = "A response from the Conversation service.")
  @NotNull
  ...
  public LogExport logId(String logId) {
    this.logId = logId;
    return this;
  }
  ...
  **/
  ...
  public LogExport requestTimestamp(String requestTimestamp) {
  ...
  **/
  ...
  public LogExport responseTimestamp(String responseTimestamp) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    LogExport logExport = (LogExport) o;
    return Objects.equals(this.request, logExport.request) &&
        Objects.equals(this.response, logExport.response) &&
        Objects.equals(this.logId, logExport.logId) &&
        Objects.equals(this.requestTimestamp, logExport.requestTimestamp) &&
        Objects.equals(this.responseTimestamp, logExport.responseTimestamp);
  }
