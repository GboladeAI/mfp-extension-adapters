...
public class CreateCounterexample   {
  ...
  public CreateCounterexample text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  @JsonProperty("text")
  @ApiModelProperty(required = true, value = "The text of a user input marked as irrelevant input.")
  @NotNull
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateCounterexample createCounterexample = (CreateCounterexample) o;
    return Objects.equals(this.text, createCounterexample.text);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateCounterexample {\n");
