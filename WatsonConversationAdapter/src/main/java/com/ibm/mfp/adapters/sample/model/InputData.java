 ...
 */
@ApiModel(description = "An object defining the user input.")
...
public class InputData   {
  ...
  public InputData text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  @JsonProperty("text")
  @ApiModelProperty(required = true, value = "The text of the user input.")
  @NotNull
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.text, inputData.text);
  }
