...
import com.ibm.mfp.adapters.sample.model.BaseCounterexample;
...
public class CounterexampleRequest   {
  @JsonProperty("text")
  private String text = null;

  public CounterexampleRequest text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  @JsonProperty("text")
  @ApiModelProperty(value = "The text of the example to be marked as irrelevant input.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CounterexampleRequest counterexampleRequest = (CounterexampleRequest) o;
    return Objects.equals(this.text, counterexampleRequest.text);
  }
  ...
  public String toString() {
    ...
    sb.append("class CounterexampleRequest {\n");
