...
public class Utterance   {
  ...
  **/
  @JsonProperty("text")
  @ApiModelProperty(required = true, value = "An utterance contributed by a user in the conversation that is to be analyzed. The utterance can contain multiple sentences.")
  @NotNull
  ...
  public Utterance user(String user) {
    this.user = user;
    return this;
  }
  ...
  **/
  @JsonProperty("user")
  @ApiModelProperty(value = "A string that identifies the user who contributed the utterance specified by the `text` parameter.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.text, utterance.text) &&
        Objects.equals(this.user, utterance.user);
  }
