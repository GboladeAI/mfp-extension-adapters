 ...
 */
public class WatsonToneAnalyzerAdapterApplication extends MFPJAXRSApplication {

    /**
     * The logger used by the app
     */
    static Logger logger = Logger.getLogger(WatsonToneAnalyzerAdapterApplication.class.getName());
