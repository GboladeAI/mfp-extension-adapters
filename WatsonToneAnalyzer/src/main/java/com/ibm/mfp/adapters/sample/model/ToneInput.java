...
public class ToneInput   {
  ...
  public ToneInput text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  @JsonProperty("text")
  @ApiModelProperty(required = true, value = "The input content that the service is to analyze. Sentences with fewer than three words cannot be analyzed.")
  @NotNull
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ToneInput toneInput = (ToneInput) o;
    return Objects.equals(this.text, toneInput.text);
  }
