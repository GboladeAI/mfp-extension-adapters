...
import com.ibm.mfp.adapters.sample.model.UtteranceAnalysis;
...
public class UtteranceAnalyses   {
  ...
  private List<UtteranceAnalysis> utterancesTone = new ArrayList<UtteranceAnalysis>();

  public UtteranceAnalyses utterancesTone(List<UtteranceAnalysis> utterancesTone) {
    this.utterancesTone = utterancesTone;
    return this;
  }

  public UtteranceAnalyses addUtterancesToneItem(UtteranceAnalysis utterancesToneItem) {
    this.utterancesTone.add(utterancesToneItem);
    return this;
  }
  ...
  **/
  @JsonProperty("utterances_tone")
  @ApiModelProperty(required = true, value = "An array of `UtteranceAnalysis` objects that provides the results for each utterance of the input.")
  @NotNull
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UtteranceAnalyses utteranceAnalyses = (UtteranceAnalyses) o;
    return Objects.equals(this.utterancesTone, utteranceAnalyses.utterancesTone);
  }

  @Override
  public int hashCode() {
    return Objects.hash(utterancesTone);
  }
  ...
  public String toString() {
    ...
    sb.append("class UtteranceAnalyses {\n");
    
    sb.append("    utterancesTone: ").append(toIndentedString(utterancesTone)).append("\n");
    sb.append("}");
    return sb.toString();
  }
