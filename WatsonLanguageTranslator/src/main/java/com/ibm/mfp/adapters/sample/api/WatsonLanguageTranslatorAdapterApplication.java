 ...
 */
public class WatsonLanguageTranslatorAdapterApplication extends MFPJAXRSApplication {

    /**
     * The logger used by the app
     */
    static Logger logger = Logger.getLogger(WatsonLanguageTranslatorAdapterApplication.class.getName());
