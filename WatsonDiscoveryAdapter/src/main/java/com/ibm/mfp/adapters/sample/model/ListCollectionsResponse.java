...
public class ListCollectionsResponse   {
  ...
  public ListCollectionsResponse collections(List<Collection> collections) {
  ...
  **/
  @JsonProperty("collections")
  @ApiModelProperty(value = "An array containing information about each collection in the environment")
